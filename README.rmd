...
COINr was initially developed under contract for the European Commission's Joint Research Centre and this enabled the package to get off the ground. Since then I have almost completely rewritten the package and significantly improved and extended it to meet the needs of other projects, and in my own time.
