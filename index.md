# COINr ![](reference/figures/COINr_logo.png)
...
[`vignette("overview")`](https://bluefoxr.github.io/COINr/articles/overview.md).
...
changed to make the package more consistent. See
[`vignette("v1")`](https://bluefoxr.github.io/COINr/articles/v1.md) to
