...
coin <- treat2(coin, dset = "Raw", default_specs = list(f1_para = list(winmax = 1)))
...
coin <- treat2(coin, dset = "Raw", indiv_specs = indiv_specs)
```
