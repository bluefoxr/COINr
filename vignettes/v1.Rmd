...
# COINrX: Apps and widgets

It may be that actually, you rather liked the Shiny apps and interactive plots. A shame, you say, to chuck those things away. Well, along those lines I have/will archive the removed apps and plots in a separate extension package called "COINrX". At the time of writing, I haven't yet got round to doing this, but it shouldn't take too long.

The idea of COINrX is that if you don't want all the interactive stuff, just install COINr. If you *do* also want that, install COINr and then also install COINrX. When you want to generate interactive plots, load up COINrX and it will add the missing functions.
