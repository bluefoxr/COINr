...
In short, here we discuss obtaining indicator statistics, correlations, data availability, and some slightly more complex ideas such as effective weights, Cronbach's alpha and principal component analysis.
...
NOTE: I need to maybe make an extra func here get_PCA_weights(), then keep get_PCA() for just the PCA output.
